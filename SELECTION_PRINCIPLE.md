...
- **H.265 for POV, AAC for acoustic, `application/octet-stream` timed metadata for everything else.** The container's track diversity is the architectural feature; codec choice per track follows convention.
